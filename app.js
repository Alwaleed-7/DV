  ...
  2: {
    ...
    questions: [
      ...
      },
      {
        ...
        explanation: 'ANSWER: Scatter plot. This is ideal because you have two continuous numerical variables (temperature and sales) and want to explore their relationship. Each point represents one time period, and the overall pattern will reveal the correlation between temperature and ice cream sales.'
      },
      {
        type: 'open',
  ...
  4: {
    ...
    questions: [
      ...
      },
      {
        ...
        rubric: 'Use plt.plot() for multiple lines or seaborn lineplot; include labels and legend',
...
const FINAL = {
  tf: [
    ...
    {text:'The plt.barh() function creates vertical bar charts.', answer:false, explanation:'FALSE: plt.barh() creates HORIZONTAL bar charts. plt.bar() creates vertical ones.'},
...
function updateProgressUI() {
  ...
  document.getElementById('progress-text').textContent = `${completed}/4 chapters completed`;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (state.completedChapters.size === 4) {
    state.finalUnlocked = true;
    document.getElementById('final-lock')?.classList.add('hidden');
    document.getElementById('final-container')?.classList.remove('hidden');
  }
